...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("$84.99").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("$84.99")_;_script infofile_;_ZIP::ssf2.xml_;_
